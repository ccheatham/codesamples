...
if(isset($_POST['save_x'])){
	...
	$query .= " where organizationid = " . "'" . $_GET['organizationid'] . "'";
...
if(isset($_POST['editproductset_x'])){		
		...
		for ($i = 0; ; $i++) {
		   if ($i == count($a_workingeditsetkeys)) {
			...
			$query .= " where fk_organizationid = " . "'" . $_GET['organizationid'] . "'";
...
$getorganizationinformation = "select o.* from organization o where organizationid = " . "'" . $_GET['organizationid'] . "'";
...
and organizationid = " . "'" . $_GET['organizationid'] . "'";
	...
	<?  include 'http://' . $_SERVER["HTTP_HOST"] . '/tally/include/header.php' ?>
		...
		<td>
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr><td  d="logout"><? include 'include/adminnav.php'; ?></p></td></tr>
				<tr class="orgDetails">
					<td><h1><img src="../images/editOrg.gif" border="0">&nbsp; Edit&nbsp;<?  echo $thisOrganization['company'] ?></h1></td>
				</tr>		
				<tr>
					<td>
						<form action="<?  echo $_SERVER['SCRIPT_NAME'] ?>?organizationid=<?  echo $_GET['organizationid'] ?>" method="post">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="content" width="500">
								...
								<tr>
									...
									<td> <input type="text" name="custnum" size="6" value="<?  echo $thisOrganization['custnum'] ?>"></td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" name="city" size="30" value="<?  echo $thisOrganization['city'] ?>"></td>
								</tr>
								
								<tr>
									<td background="../images/pattern.gif"><p>State: </p></td>
									<td><input type="text" name="state" size="2" maxlength="2" value="<?  echo $thisOrganization['state'] ?>"></td>
								</tr>
								
								<tr>
									<td background="../images/pattern.gif"><p>Zip: </p></td>
									<td><input type="text" name="zipcode" size="10" value="<?  echo $thisOrganization['zipcode'] ?>"></td>
								</tr>
								
								<tr>
									<td background="../images/pattern.gif"><p>Country: </p></td>
									<td><input type="text" name="country" size="30" value="<?  echo $thisOrganization['country'] ?>"></td>
								</tr>
							</table>
							...
							<table cellpadding="0" cellspacing="0" border="0" width="500" class="content">
								<tr>
									<td bgcolor="#cccccc" colspan="3"><p><strong><? echo strtoupper($organizationproductsets['name'] . ' Products') ?></strong></p></td>
								</tr>
								
								<tr class="prodNumb">
									<td width="25%"><p>NUMBER</p></td>
									<td width="45%"><p>NAME</p></td>
									<td width="30%" align="right"><p>UNIT PRICE</p></td>
								</tr>
								<?  
									$getproductsetproducts = "select p.productid, p.name as productname, p.sku, o_p.productprice, ps.productsetid
									...
									and ps.productsetid =  '" .  $organizationproductsets['productsetid'] . "' and o_ps.fk_organizationid = '" . $_GET['organizationid'] . "' group by p.productid";
